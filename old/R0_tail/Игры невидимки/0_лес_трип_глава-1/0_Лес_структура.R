...
(с) Данные Скомпрометированы

#Cтруктура
    _Заголовок: "0__трип_глава-1"
    _Цели: Репрезентации: Старичёк, Саара, Лес, Ходоки, Переводимые на другой круг. Механика Леса и его восприятие. Игра цвета и карты.
 ...
 - домик Старичка пуст. ищет наследника. Им становится Желтый.
...
система ламается 
и Ходоки теперь перемещаются через точки входа и Лес
Раньше они прыгали через точку входа в Изнанку и в Дом и Пустырь.
Теперь Лес стал посредником втянут в эту позу с побегом Старичка и пропажей куска ВВС из-за сокрытия следов пребывания тут Старичком от Дуета.
