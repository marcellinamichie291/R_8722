R(Жертва):
    Время: Раньше и Потом;
    Отношения с М\П: М-Зависимые_Паучиха_Паразит, П-0;
    Сценарий: Питер-Пен_Эдип;
        Процес:
            После... сначала деньги;пен;
            Всегда... непонимание, не внимательность, лень, прокрастинация;
            Почти... Я стараюсь, саботаж ребёнок демон, незавершенность;
        Запреты: Не быть нормальным, Не взрослеть, не сближатся, Не быть счастливым, не чувствовать, Не действовать, не достигать успеха, не быть значимым.
        План: Родственник был тайным алкашом. Наказать себя тяжелой работой. Повод для дозы.
            ...должен сделать чтобы почувствовать себя в порядке
            тонапокалиптического плача разной степени сдержанности
        Купоны: "Сделай мне больно, чтобы я имел право сделать больно тебе.";
        Сказка\Oбёртка: 'био-панк', 
