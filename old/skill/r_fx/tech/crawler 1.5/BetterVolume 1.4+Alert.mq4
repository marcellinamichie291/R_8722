      ...
      if (Time[0] != LastAlert) {
         ...
         if (red[1] > 0) {
            if (AlertSound)
               PlaySound("alert");
            if (AlertPopup)
               Alert(Symbol() +" "+PeriodToText(Period())+ " Climax High");
            if (AlertEmail)
               SendMail(WindowExpertName() + " - " + Symbol() +" "+PeriodToText(Period())+ " Climax High","New Climax High");
         }//if (red[1] > 0)          
         ...
         if (white[1] > 0) {
            if (AlertSound)
               PlaySound("alert");
            if (AlertPopup)
               Alert(Symbol() +" "+PeriodToText(Period())+ " Climax Low");
            if (AlertEmail)
               SendMail(WindowExpertName() + " - " + Symbol() +" "+PeriodToText(Period())+ " Climax Low","New Climax Low");
         }//if (white[1] > 0) 
