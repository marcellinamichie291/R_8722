function BookDiscovery() {
    return (
        <div className="rCol-lg-4" id="r_Del2">
            <div className="r_boxCol">

                <button type="button" className="r_box1BtnDel btn btn-default btn-danger" id="r_box1Col1DeleteBtn" onClick="r_Delete2()">X</button>
                <div className="r_boxColHead">
                <img 
                    className="r_boxColImg" 
                    id="r_box1ColImg" 
                    src={require('../../img/pik-conf1.png')} 
                    alt="img/pik-conf1.png" 
                />
                <h3 id="">Discovery</h3>
                </div>
                ...
                <div className="rRow">
                    ...
                    <p className="" id="r_box1ColTime">from 13 to 14</p>
                    </div>
                </div>
                ...
                <div className="rRow">
                    ...
                    <p id="r_box1ColAbout">Get some basic knowledge <br/> Study a new tool</p>
                    </div>
                </div>
