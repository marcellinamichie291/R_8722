function BookSyncUp() { return (
  <div className="rCol-lg-4" id="r_Del1">
    <div className="r_boxCol r_boxCol1">

    <button type="button" className="r_box1BtnDel btn btn-default btn-danger" id="r_box1Col1DeleteBtn" onClick="r_Delete1()">X</button>

    <div className="r_boxColHead">
      <img 
        className="r_boxColImg" 
        id="r_box1ColImg" 
        src={require('../../img/pik-conf.png')} 
        alt="img/pik-conf.png" 
      />
      <h3 id="r_box1ColH3">Sync-Up</h3>
    </div>
    ...
    <div className="r_boxColContent">
      ...
      <div className="rRow">
        ...
        <div className="rCol-10" id="r_box2Time">
          <p className="" id="r_box1ColTime">10pm-11pm</p>
        </div>
      </div>
      ...
      <div className="rRow">
        ...
        <div className="rCol-10" id="r_box2About">
          <p id="r_box1ColAbout">Tell your blockers <br/> Meet new people</p>
        </div>
      </div>
