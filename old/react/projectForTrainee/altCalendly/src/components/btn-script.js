...
//   <div className="rCol-lg-4" id="r_Del4">
//   <div className="r_boxCol">

//     <button type="button" className="r_box1BtnDel btn btn-default btn-danger" id="r_box1Col1DeleteBtn" onClick="r_Delete4()">X</button>
//     <div className="r_boxColHead">
//       <img  className="r_boxColImg" id="r_boxCol1Img" src="pik-conf.png"/>
//       <h3 id="r_box1ColH3">
//         ${r_box2FormSave.H}
//       </h3>
//     </div>
...
//     <a href="#r_block" className="r_box1Btn" id="r_box1ColTimeBtn" onClick="r_Book()">BOOK ></a>
//   </div>
// </div>
//   `;
//   // del
